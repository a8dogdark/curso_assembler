...
NUEVOARTICULODLI
	.BYTE $70,$70,$70,$46
	.WORD TITULONUEVOARTICULO
	.BYTE $70,$42
	.WORD TEXTONUEVOARTICULO
	.BYTE $02,$02,$02,$02,$02,$02,$02,$02
	.BYTE $02,$02,$02,$02,$02,$02,$02,$02
	.BYTE $02,$02,$02,$02
	.BYTE $41
	.WORD NUEVOARTICULODLI
NUEVOARTICULO
	LDA #<NUEVOARTICULODLI
	STA $230
	LDA #>NUEVOARTICULODLI
	STA $231
	RTS
...
TITULONUEVOARTICULO
	.SBYTE +64,"ORGANIZADOR DE DISCO"
TEXTONUEVOARTICULO
	.SBYTE +128,"            NUEVO  ARTICULO             "
	.SBYTE "                                        "
	.SBYTE "                                        "
	.SBYTE "NUMERO DE REGISTRO 0000                 "	;4
	.SBYTE "                                        "
	.SBYTE "TITULO    : "
NUEVOTITULO
	.SBYTE "..........................."
TEXTONUEVOARTICULO01	
	.SBYTE " "	;27
	.SBYTE "CATEGORIA : "
NUEVOCATEGORIA
	.SBYTE "..........................."
TEXTONUEVOARTICULO02
	.SBYTE " "	;27
	.SBYTE "DISCO     : "
NUEVODISCO	;NUEVODISCO$
	.SBYTE "......"
TEXTONUEVOARTICULO03
	.SBYTE "                      "	;6
	.SBYTE "                                        "
	.SBYTE "                                        "
	.SBYTE "                                        "
